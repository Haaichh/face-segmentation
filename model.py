...
class UNet(nn.Module):
    def __init__(self, features=32):
        ...
        self.upconv1 = nn.ConvTranspose2d(in_channels=features*16, out_channels=features*16, kernel_size=2, stride=2)
        self.up1 = nn.Conv2d(in_channels=(features*5)*4, out_channels=features*8, kernel_size=3, stride=1, padding='same')
        self.up2 = nn.Conv2d(in_channels=features*8, out_channels=features*8, kernel_size=3, stride=1, padding='same')

        self.upconv2 = nn.ConvTranspose2d(in_channels=features*8, out_channels=features*8, kernel_size=2, stride=2)
        self.up3 = nn.Conv2d(in_channels=(features*5)*2, out_channels=features*4, kernel_size=3, stride=1, padding='same')
        self.up4 = nn.Conv2d(in_channels=features*4, out_channels=features*4, kernel_size=3, stride=1, padding='same')

        self.upconv3 = nn.ConvTranspose2d(in_channels=features*4, out_channels=features*4, kernel_size=2, stride=2)
        self.up5 = nn.Conv2d(in_channels=features*5, out_channels=features*2, kernel_size=3, stride=1, padding='same')
        self.up6 = nn.Conv2d(in_channels=features*2, out_channels=features*2, kernel_size=3, stride=1, padding='same')

        self.upconv4 = nn.ConvTranspose2d(in_channels=features*2, out_channels=features*2, kernel_size=2, stride=2)
        self.up7 = nn.Conv2d(in_channels=67, out_channels=features, kernel_size=3, stride=1, padding='same')
