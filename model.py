...
class UNet(nn.Module):
    def __init__(self, features=64, mode=None):
        ...
        self.batchnorm1 = nn.BatchNorm2d(features, track_running_stats=False)
        self.batchnorm2 = nn.BatchNorm2d(features*2, track_running_stats=False)
        self.batchnorm3 = nn.BatchNorm2d(features*4, track_running_stats=False)
        self.batchnorm4 = nn.BatchNorm2d(features*8, track_running_stats=False)
        self.batchnorm5 = nn.BatchNorm2d(features*16, track_running_stats=False)

        self.down1 = nn.Conv2d(in_channels=1, out_channels=features, kernel_size=3, stride=1, padding='same')
